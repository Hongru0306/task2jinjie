...
def load_model():
    model = (
        AutoModelForCausalLM.from_pretrained('/CV/xhr_project/llm/model/internlm2-chat-7b/Shanghai_AI_Laboratory/internlm2-chat-7b', trust_remote_code=True, low_cpu_mem_usage=True)
        .to(torch.bfloat16)
        .cuda()
    )
    tokenizer = AutoTokenizer.from_pretrained('/CV/xhr_project/llm/model/internlm2-chat-7b/Shanghai_AI_Laboratory/internlm2-chat-7b', trust_remote_code=True, low_cpu_mem_usage=True)
